...
const combinedFlavors = originalFlavors.concat(newFlavors.concat(seasonalFlavors.concat(regionalFlavors)))

function getRandomFlavors(array) {
  /*code here*/
  const combinedFlavorsArray = [];

  for (let i = 0; i < 31; i++) {
    let randomFlavors = Math.random() * array.length;
    combinedFlavorsArray.push(array.splice(randomFlavors, 1))
  }
  return combinedFlavorsArray;
}

console.log('Stretch 2:', getRandomFlavors(combinedFlavors));
